...
<!-- MENU END -->
   ...
   <div class="main">
		<div class="main_top">
         ...
         <center>
         <form action="UpdateElectronics.php" method="post"> 
            ...
            <table>
              ...
              $sql=mysql_query('select IID from item where IType="Electronics" && Username="'.$_SESSION['logged_admin'].'"');
...
?> 
         <center> <form action="DBUpdateElectronics.php" method="post">
		<table >
          <tr>
     ...
     <option value="DVD Players" <?php echo ($category == "DVD Players") ? 'selected="selected"': ''; ?>>DVD Players</option>
<option value="Audio Equipments" <?php echo ($category == "Audio Equipments") ? 'selected="selected"': ''; ?>>Audio Equipments </option>

	<option value="Mobile Phones" <?php echo ($category == "Mobile Phones") ? 'selected="selected"': ''; ?>>Mobile Phones</option>
    <option value="Printers & Scanners" <?php echo ($category == "Printers & Scanners") ? 'selected="selected"': ''; ?>>Printers & Scanners</option>
    <option value="Digital Camera & Camcorders" <?php echo ($category == "Digital Camera & Camcorders") ? 'selected="selected"': ''; ?>>Digital Camera & Camcorders</option>
    <option value="Home Theater Systems" <?php echo ($category == "Home Theater Systems") ? 'selected="selected"': ''; ?>>Home Theater Systems</option>
    <option value="Computer & Notebook" <?php echo ($category == "Computer & Notebook") ? 'selected="selected"': ''; ?>>Computer & Notebook</option>
               </select></td>
                </tr> 
