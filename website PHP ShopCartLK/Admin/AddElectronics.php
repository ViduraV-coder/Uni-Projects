...
?>
   ...
   <div class="main">
		<div class="main_top">
         ...
         <center> <form action="DBAddElectronics.php" method="post">
		<table >
          <tr>
            <td><font  class="Fstyle">Item ID </font> </td> <td><input name="txtIID" type="text" required class="textbox" title="Type Item ID" value="<?php echo $newIID; ?>" readonly></td>
		 	...
		 	<tr>
                	<td><font  class="Fstyle">Category </font></td> <td> <select class="select" name="txtCategory" title="Select Category">
                            <option value="DVD Players" SELECTED>DVD Players</option>
                            <option value="Audio Equipments" >Audio Equipments </option>
                            <option value="Mobile Phones" >Mobile Phones </option>
                            <option value="Printers & Scanners" >Printers & Scanners </option>
                            <option value="Digital Camera & Camcorders" >Digital Camera & Camcorders </option>
          ...
          <input type="submit" value="Add Items"  class="Sbutton" title="Click here to Add "> 
         </form> </center><br>
