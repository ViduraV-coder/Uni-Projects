...
<th> <div class="txt-heading"> PID </div> </th>
...
<th> <div class="txt-heading"> Date </div></th>
<th><div class="txt-heading"> Quantity</div></th>
<th><div class="txt-heading"> Price</div></th>
<th><div class="txt-heading"> Total</div></th>
</tr>	
 <?php 
...
$query = 'Select * from purchases where Username="'.$_SESSION['logged_admin'].'"';
