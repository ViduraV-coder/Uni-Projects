   ...
   <div class="main">
		<div class="main_top">
         ...
         <form action="UpdateVehicles.php" method="post"> 
            ...
            $sql=mysql_query('select IID from item where IType="Vehicles" && Username="'.$_SESSION['logged_admin'].'"');
...
?> 
         <center> <form action="DBUpdateVehicles.php" method="post">
		<table >
          <tr>
            <td><font class="Fstyle">Item ID </font> </td> <td><input class="textbox" name="txtIID" type="text" value='<?php echo $iid; ?>' readonly></td>
		 	...
		 	<tr>
               ...
               <option value="Car" <?php echo ($category == "Car") ? 'selected="selected"': ''; ?>>Car</option>
               <option value="Van" <?php echo ($category == "Van") ? 'selected="selected"': ''; ?>>Van </option>
               <option value="Bus" <?php echo ($category == "Bus") ? 'selected="selected"': ''; ?>>Bus</option>
               <option value="ThreeWheel" <?php echo ($category == "ThreeWheel") ? 'selected="selected"': ''; ?>>ThreeWheel </option>
               <option value="Motor Bike" <?php echo ($category == "Motor Bike") ? 'selected="selected"': ''; ?>>Motor Bike</option>
