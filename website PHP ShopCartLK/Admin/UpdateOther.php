...
<!-- MENU END -->
   ...
   <div class="main">
		<div class="main_top">
         ...
         <center>
         <form action="UpdateOther.php" method="post"> 
            ...
            $sql=mysql_query('select IID from item where IType="Other" && Username="'.$_SESSION['logged_admin'].'"');
...
?> 
         <center> <form action="DBUpdateOther.php" method="post">
		<table >
          <tr>
            <td><font class="Fstyle">Item ID </font> </td> <td><input class="textbox" name="txtIID" type="text" value='<?php echo $iid; ?>' readonly></td>
		 	...
		 	<tr>
               ...
               <option value="Generators" <?php echo ($category == "Generators") ? 'selected="selected"': ''; ?>>Generators</option>
               <option value="Skirts" <?php echo ($category == "Skirts") ? 'selected="selected"': ''; ?>>Skirts </option>
               <option value="Water Pumps" <?php echo ($category == "Water Pumps") ? 'selected="selected"': ''; ?>>Water Pumps</option>
               <option value="Fitness Equipment" <?php echo ($category == "Fitness Equipment") ? 'selected="selected"': ''; ?>>Fitness Equipment </option>
               <option value="Agro Products" <?php echo ($category == "Agro Products") ? 'selected="selected"': ''; ?>>Agro Products</option>
