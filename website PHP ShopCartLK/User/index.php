...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a><img style="width:100%" src="themes/images/carousel/2.png" alt=""/></a>
		  ...
		  <div class="item">
		  <div class="container">
			<a ><img src="themes/images/carousel/3.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a ><img src="themes/images/carousel/4.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a ><img src="themes/images/carousel/5.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
			</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a ><img src="themes/images/carousel/6.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
	  ...
	  <ul id="sideManu" class="nav nav-tabs nav-stacked">
		...
		<br/>
		  <div class="thumbnail">
			...
			<div class="caption">
			  <h5>Panasonic</h5>
				<h4 style="text-align:center"><a class="btn btn-primary" >Rs.222.00</a></h4>
			</div>
		  </div><br/>
			<div class="thumbnail">
...
<!-- Sidebar end=============================================== -->
	...
	$query="SELECT * FROM `item` WHERE `Category`='DVD Players' ";
