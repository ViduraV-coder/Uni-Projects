...
<th><div class="txt-heading"> Action</div></th>
...
$Total = 0;	
		...
		while($row=mysql_fetch_array($result))	
   {
		...
		?>
                ...
                <th>
                <form action="DBUpdateQty.php" method="post"> 
                
                <input type="hidden" name="IID" value="<?php echo $row["IID"]; ?>">
                <input type="hidden" name="UnitPrice" value="<?php echo $row["UnitPrice"]; ?>">
				
				                    
               <input type="text" name="txtQuantity" size="1" value="<?php echo $row["Quantity"]; ?>"  />
               <input type="submit" value="Add"  class="btn" onclick="form.action='DBUpdateQty.php';" />
               </form>
                </th>
                
                <th><?php echo "Rs.".$row["UnitPrice"]; ?> </th> 
                <th><?php echo $row["SubTotal"]; ?> </th>
               <th>   <form action="DBDeleteCart.php" method="post"> 
                <input type="hidden" name="IID" value="<?php echo $row["IID"]; ?>">
  <input type="submit" type="submit" value="Remove Item" class="btn" onclick="form.action='DBDeleteCart.php';"/>
               </form> </th>
...
<center><input type="submit" name="txtPay" type="submit" value="Check Out" class="btn btn-large"/></center>
</form>	
