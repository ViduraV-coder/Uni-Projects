		...
		<div class="span4">
			...
			<form action="DBLogin.php" method="post">
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" placeholder="Username" name="txtUsername" required>
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword1">Password</label>
				<div class="controls">
				  <input type="password" class="span3" placeholder="Password" name="txtPassword" required>
				</div> <br> 
                 <font color="#FF0000">
		              <?php 
		 			    if(isset($_GET['msg']))
