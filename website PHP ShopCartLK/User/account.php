...
?>
		...
		<div class="control-group">
		 <form action="DBUpdateUser.php" method="post">
              <table >
              	<tr>
                	<td>
                ...
                <tr>
                	<td> <font class="Fstyle"> Last Name </font> </td>
                     <td><input name="txtLname" type="text" required class="textbox" title="Type your last name" placeholder="Enter your last name" value='<?php echo $lname; ?>'></td>
                </tr>
		        <tr>
                	<td> <font class="Fstyle"> NIC </font></td>
                     <td> <input name="txtNIC" type="text" required class="textbox" maxlength="10" title="Type your NIC No" placeholder="Enter your NIC" value='<?php echo $nic; ?>'></td>
                </tr>
               <tr>
				...
				<tr>
                	<td><font class="Fstyle"> Email </font></td>
                     <td> <input name="txtEmail" type="email" required class="textbox" title="Type your email" placeholder="Enter your email" value='<?php echo $email; ?>'></td>
                </tr>
                <tr>
                	<td><font class="Fstyle"> Username </font> </td>
                     <td><input name="txtUsername" type="text" required class="textbox" title="Type your username" placeholder="Enter your username" value='<?php echo $un; ?>' readonly></td>
                </tr>
                <tr>
	...
	<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-large btn-success" type="submit" value="Change" title="Click here to Edit" />
