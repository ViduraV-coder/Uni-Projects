...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="DVD.php">Products</a> <span class="divider">/</span></li>
...
$iid = $_POST['IID'];
    ...
    <form method="post" action="DBCart.php">
     <input type="hidden" name="IID" value="<?php echo $row["IID"]; ?>">
            <input type="hidden" name="PUsername" value="<?php echo $row["PUsername"]; ?>">
	...
	<div class="row">	  
            ...
            <a href="<?php echo $row["Image"]; ?>" title="<?php echo $row["IName"]; ?>">
				<img src="<?php echo $row["Image"]; ?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?php echo $row["Image"]; ?>"> <img style="width:29%" src="<?php echo $row["Image"]; ?>" alt=""/></a>
                   <a href="<?php echo $row["Image"]; ?>"> <img style="width:29%" src="<?php echo $row["Image"]; ?>" alt=""/></a>
			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <div class="control-group">
					<label class="control-label"><span><strong><?php echo "Rs.".$row["Price"]; ?></strong></span></label>
					<div class="controls">
                    <input type="text" name="txtQuantity" value="1" class="span1" placeholder="Qty."/>
					
					  <input type="submit" class="btn btn-large btn-primary pull-right" value="Add to cart"> </input>
					</div>
				  </div>
