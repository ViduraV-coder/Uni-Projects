 ...
 * @author RVishwajith
 */
public class industryProblems extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!"".equals(getName)) {
                ...
                String pathFinal = "C://IndustryProblemUploads_" + inID + "//";
                File directory = new File("C://IndustryProblemUploads_" + inID);
        ...
        response.sendRedirect("industryProblems.jsp");
    }
}
