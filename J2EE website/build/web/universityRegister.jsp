...
<html>
    <head>
        ...
        <title>University_Registration Page</title>
        <link rel="stylesheet" href="./ScriptsCss/style2.css">
    ...
    <body class="left-menu" style="background-color: #585b60;">  
        ...
        <div id="wrapper" style="background-image: url(Images/study-notebooks.jpg);background-repeat:no-repeat;background-size: cover">

            <form action="universityRegister" method="post" name="iForm">
                <section>     
                    <div class="LoginBox">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="color: purple; font-size: 17px; font-family: sans-serif; font-weight: bold; text-align: right;">Tele No :</td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: center;"><button class="btn1" type="reset" value="RESET" >RESET</button></td>
                            </tr>
