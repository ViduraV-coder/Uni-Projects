    ...
    <body class="left-menu" style="background-color: #585b60;">  
        ...
        <div id="wrapper">
            <div style="padding-top: 50px; text-align: center">
                <form   id="form1"  action="industryProblems" method="post" enctype="multipart/form-data">  
                ...
                <table id="tbl" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
                    ...
                    <tbody>
                        <%
                            ...
                            ResultSet rs = database.getProblems("inProblems_" + id);
                            try {
                                while (rs.next()) {
                        ...
                        <tr bgcolor="#DEB887">
                            ...
                            <td style=" width: 15%"><input id="update" type="button" value="Update" name="update" onClick="updateButton(this)" />  
            ...
            <div id="myModal2" class="modal">
                <div class="modal-content" style="text-align: center">
                    <div style="align-items:center;justify-content: center">
                        <form style="display:none;"  id="form2"  action="industryProblems" method="post" enctype="multipart/form-data">  
