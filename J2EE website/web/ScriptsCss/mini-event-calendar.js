...
<style>
a:hover {
  box-shadow: inset 200px 200px 200px 200px rgba(255, 255, 255, 0.3);
		...
		<div id="calTFooter">
			...
			<a href="javascript:void(0);" id="calLink">ADD EVENT</a>
                        <a style="display:none;text-decoration:none;color:yellow;font-size:12.5px;font-weight:bold;padding:10px;" href="javascript:void(0);" id="editLink">EDIT EVENT</a>
		</div>
	`;
        ...
        calendar_link : "",
                ...
                var eventsEditLink = miniCalendar.find("#editLink");
                var today = new Date();
        ...
        var mover = $(this);
                ...
                tbody.html("");
                        ...
                        eventsLink.text("ADD EVENT");
                        eventsLink.attr("onClick", "addEvent()");
                        eventsEditLink.text("EDIT EVENT");
                        eventsEditLink.attr("onClick", "editEvent()");
                        curMonth = month;
                        curYear = year;
        ...
        document.getElementById("tempDate").value = event.date;
        document.getElementById("tempDesc").value = event.title;
                eventsLink.text("DELETE EVENT");
                eventsLink.attr("onClick", "deleteEvent()");
                eventsEditLink.text("EDIT EVENT");
                eventsEditLink.css("display", "block");
                eventsEditLink.attr("onClick", "editEvent()");
        } else{
        eventsEditLink.css("display", "none");
