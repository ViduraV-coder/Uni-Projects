...
<html>
        ...
        <div id="wrapper">
                ...
                <table id="tbl" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
                    ...
                    <tbody>
                        <%
                            ...
                            ArrayList<ArrayList> al = database.getProblemAnswers("industry");
                        ...
                        <tr bgcolor="#DEB887">
                            ...
                            <td style=" width: 20%"><%=problemGiverName.get(i)%></td>
            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <div style="align-items:center;justify-content: center">
                        ...
                        <h3>Give answer:-</h3>
                        <br>
                        <form  id="form2"  action="industryAnswers" method="post" enctype="multipart/form-data">  
            ...
            <div id="myModal2" class="modal">
                <div class="modal-content" style="text-align: center">
                    <div style="align-items:center;justify-content: center">
                        <form style="display:none;"  id="form3"  action="industryAnswers" method="post" enctype="multipart/form-data">  
    ...
    <script>
        ...
        function deleteButton(x) {
            ...
            var tblname = "inGivenAnswers_<%=id%>";
            $.ajax({
                type: 'POST',
                url: 'industryAnswersDelete',
        ...
        function createTabel(answerGiverId, answerGiver, answerId, answer, file) {
            ...
            for (i = 0; i <= answerGiver.length - 1; i++) {
                ...
                z5.setAttribute("style", "width: 10%");
