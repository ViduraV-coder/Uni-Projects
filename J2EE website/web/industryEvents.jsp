...
<html>
    ...
    <body class="left-menu" style="background-color: #585b60;">  
        ...
        <div id="wrapper">
            <div style="padding-top: 50px; text-align: center">
                <form  id="form1"  action="industryEvents" method="post" enctype="multipart/form-data">  
                ...
                <table id="tbl" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered">
                    ...
                    <tbody>
                        <%
                            ...
                            ResultSet rs = database.inGetEvents(id);
                            try {
                                while (rs.next()) {
                        ...
                        <tr bgcolor="#DEB887">
                            ...
                            <td style=" width: 80%"><div style="overflow-y: scroll; width:100%; height:150px;"><%=rs.getString("Description")%></div></td>
            ...
            <div id="myModal" class="modal">
                <div class="modal-content" style="text-align: center">
                    ...
                    <div style="align-items:center;justify-content: center">
                        <form style="display:none;"  id="form2"  action="industryEvents" method="post" enctype="multipart/form-data">  
    ...
    <script>
        ...
        function deleteButton(x) {
            var indx = x.parentNode.parentNode.rowIndex;
            var eid = document.getElementById("tbl").rows[indx].cells[0].innerHTML;
            var path = document.getElementById("tbl").rows[indx].cells[3].innerHTML;
            var tblname = "inevents_<%=id%>";
            $.ajax({
                type: 'POST',
                url: 'industryEventsDelete',
                data: {tblName: tblname, eID: eid, Path: path}
            });
            $(x).closest('tr').remove();
        }
    </script>
